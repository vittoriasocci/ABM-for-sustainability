...
to import-siena-map
  ...
  ;gis:set-world-envelope (gis:envelope-of world) ;tutta la rete stradale italiana
  gis:set-world-envelope (list 11.32315 11.34110 43.31153 43.32800) ;zoom sulla rete stradale del centro di Siena
  gis:set-drawing-color white  ; Imposta il colore delle strade
  gis:draw world 1  ; Disegna il layer stradale
